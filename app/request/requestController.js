...
app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog','$firebaseArray','$routeParams', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog,$firebaseArray,$routeParams){
    var query;
    ...
    $scope.showAdd = function(ev) {
        $mdDialog.show({
            ...
            templateUrl: 'request/addRequest.template.html',
            targetEvent: ev,
        })
